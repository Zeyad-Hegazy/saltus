...
const Backdrop = ({ onClick, children }) => {
	return (
		<div
			className="fixed top-0 left-0 w-full h-full z-[20] bg-[#000000bf] flex justify-center items-center"
...
const CardOverlay = ({ card, onClick }) => {
	return (
		<div className="w-[80%] md:max-h-[75%] overflow-y-auto h-fit rounded-[15px] relative bg-white py-4">
			<img
				src={close}
				alt="close icon"
				...
				onClick={() => onClick(false)}
			/>
			<div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center px-4 sm:px-[6rem]">
				<img
					src={card.image}
